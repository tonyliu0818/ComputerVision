...
class ProcessPicbeginner:
    ...
    def _update_state_sequence(self, state):
        ...
        #        self.state_tracker['state_seq'].append(state)
        if state == 's3':
            if ('s3' not in self.state_tracker['state_seq']) and ('s1' not in self.state_tracker['state_seq']):
                self.state_tracker['state_seq'].append(state)
    ...
    def process(self, frame: np.array, pose):
        ...
        if keypoints.pose_landmarks:
            ...
            # Camera is aligned properly.
                ...
                draw_dotted_line(
                    frame, hip_coord, start=hip_coord[1]-80, end=hip_coord[1]+20, line_color=self.COLORS['red'])
                ...
                draw_dotted_line(
                    frame, knee_coord, start=knee_coord[1]-50, end=knee_coord[1]+20, line_color=self.COLORS['red'])
                ...
                draw_dotted_line(
                    frame, ankle_coord, start=ankle_coord[1]-50, end=ankle_coord[1]+20, line_color=self.COLORS['red'])
                ...
                if current_state == 's1':
                    ...
                    elif 's3' in self.state_tracker['state_seq'] and len(self.state_tracker['state_seq']) == 1:
                ...
                # -------------------------------------- PERFORM FEEDBACK ACTIONS --------------------------------------
                    ...
                    if hip_vertical_angle > self.thresholds['HIP_THRESH'][1]:
                        self.state_tracker['DISPLAY_TEXT'][0] = True
                            ...
                            self.state_tracker['state_seq'].count('s3') == 1:
